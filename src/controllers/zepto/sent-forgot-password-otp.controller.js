 ...
 *
 * @function sentForgotPasswordEmailOTP
 * @async
 ...
 * {
 *   "status": 201,
 *   "message": "Forgot Password email OTP is sent",
 *   "data": {
...
import { OneMinuteFromNow } from "../../utils/date-handlers.util.js";
import OTP from "../../models/otp.model.js";


const sentForgotPasswordEmailOTP = catchAsync(async (req, res) => {
    ...
    try {
        ...
        if (!userRecord) {
            throw new AppError(statusCodes.BAD_REQUEST, AppErrorCode.EmailNotRegistered);
        }
...
export default sentForgotPasswordEmailOTP;